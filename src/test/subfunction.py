        ...
        for irc in range(len(arr4rc)):
            try:
                ...
                fout.write('%6d,%6d,%8.3f,%8.3f,%6d,%8.3f,%8.3f,%8.3f,%8.3f,%8.4f,%8.4f\n'%(arr4rc['index'].iloc[irc],\
                    isc,lon_s,lat_s,irc,lon_r,lat_r,arr4rc['vel'].iloc[irc],arr4rc['dist'].iloc[irc],dd1,dd2))
...
def plot_tomo(geogrid,vel,rootpath,iset=-1):
    ...
    plt.imshow(vel.reshape(nlat+1,nlon+1),cmap='jet',extent=(lonmin,lonmax,latmax,latmin))
